...
CHARACTER (LEN=80) :: FILE07 = 'Grid_Info'  !!  (INPUT TO PRESET AND CHIEF).
...
! ---------------------------------------------------------------------------- !
!                                                                              !
!    5.0 STANDARD OUTPUT FILE OPTION AND TIMESTEP AND DATE.                    !
!        --------------------------------------------------                    !

INTEGER            :: IREST   =  1    !! RESTART SAVE OPTION.
                                      !!  = 1  RESTART FILES ARE SAVED
                                      !!  OTHERWISE RESTART FILES ARE NOT SAVED.
INTEGER            :: IDELRES = -1    !! OUTPUT AND RESTART FILE TIMESTEP.
CHARACTER (LEN=14) :: CDTRES  = ' '   !! NEXT DATE TO SAVE OUTPUT
                                      !! AND/OR RESTART FILES.
...
INTERFACE SET_FILE_OPTION
   MODULE PROCEDURE SET_FILE_OPTION
END INTERFACE
PUBLIC SET_FILE_OPTION
...
SUBROUTINE SET_FILE_OPTION (STEP, REST)
...
INTEGER,   INTENT(IN) :: REST      !! =1 SAVE RESTART FILES.
...
END SUBROUTINE SET_FILE_OPTION
...
WRITE (IU06,'(''  GRID DATA FILE ............. UNIT:'',I3,'', NAME: '',A)')    &
&                                                         IU07, FILE07(1:LENT)
...
IF (IREST.EQ.1) THEN
   WRITE(IU06,*) ' OUTPUT AND RESTART FILES WILL BE SAVED EVERY....:',         &
&                                                          IDELRES, ' SECONDS'
ELSE
   WRITE(IU06,*) ' OUTPUT FILES WILL BE DISPOSED EVERY ............:',         &
&                                                           IDELRES, ' SECONDS'
END IF
WRITE(IU06,*) ' NEXT DATE TO SAVE FILES IS......................: ', CDTRES
WRITE(IU06,*) '  '
