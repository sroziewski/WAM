...
IF (PRESENT(TM1)) THEN
   TM1 = MATMUL(TEMP, DFFR)           !! FREQUENCY INTEGRATION.
...
IF (PRESENT(TM2)) THEN
   TM2 = MATMUL(TEMP, DFFR2)          !! FREQUENCY INTEGRATION.
...
IF (PRESENT(WM1)) THEN
   DEL2 = SQRT(G)/ZPI
   IF (PRESENT(IN)) THEN
      WM1 = MATMUL(TEMP/SQRT(TFAK(IN,:)), DFIM)
   ELSE
...
IF (PRESENT(WM2)) THEN
   DEL2 = ZPI/SQRT(G)
   IF (PRESENT(IN)) THEN
      WM2 = MATMUL(TEMP*SQRT(TFAK(IN,:)), DFIM)
   ELSE
      WM2 = MATMUL(TEMP, DEL2*DFFR)
   END IF
